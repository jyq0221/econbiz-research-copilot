...
已核验模型需要并列比较或 Word 三线表时，按 [结果交付](../../../docs/research-handbook/result-delivery.md) 保存比较和文档。比较实际键、样本与模型变化，保留所有参数与运行；不为出表自动增加模型或改变样本。与 interpret 衔接说明结果，统计状态与文档视觉检查分开。
